    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        <p className="text-muted-foreground mb-4">
          At Comet News, we take your privacy seriously. This Privacy Policy explains how we collect,
          use, disclose, and safeguard your information when you visit our website cometnews.ai or use
          our mobile application. Please read this privacy policy carefully. If you do not agree with
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          but not limited to, when you visit our site, register on the site, subscribe to our newsletter,
          respond to a survey, fill out a form, and in connection with other activities, services, features,
          or resources we make available on our Site. You may be asked for, as appropriate:
        </p>
        ...
        <p className="text-muted-foreground mb-4">
          We will collect personal identification information from you only if you voluntarily submit
          such information to us. You can always refuse to supply personal identification information,
          except that it may prevent you from engaging in certain site-related activities.
        </p>

        <h3 className="text-xl font-medium mt-6 mb-3">Non-Personal Data</h3>
        <p className="text-muted-foreground mb-4">
        ...
        <ul className="list-disc pl-5 space-y-2 text-muted-foreground mb-4">
          ...
          <li>Technical information about your means of connection to our Site</li>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Comet News may collect and use your personal information for the following purposes:
        </p>
        <ul className="list-disc pl-5 space-y-2 text-muted-foreground mb-4">
          <li><strong>To personalize your experience</strong> — We may use information in the aggregate to understand how our users as a group use the services and resources provided on our Site.</li>
          ...
          <li><strong>To send periodic emails</strong> — We may use your email address to respond to your inquiries, questions, and/or other requests. If you decide to opt-in to our mailing list, you will receive emails that may include company news, updates, related product or service information, etc.</li>
          <li><strong>To provide tailored content</strong> — We may use your reading history to suggest articles that may be of interest to you.</li>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          communication channel and is encrypted and protected with digital signatures. Our Site is also
          in compliance with PCI vulnerability standards to create as secure of an environment as possible
          for users.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          and customer service policies. Browsing and interaction on any other website, including websites which
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Our Site may use "cookies" to enhance user experience. A cookie is a small piece of data stored on
          your computer or mobile device by your web browser while you are viewing a website. These cookies
          help us to store your preferences, remember your login information, and compile statistical data.
          You can choose to disable cookies through your browser settings, or to be alerted when cookies are
          being sent. If you do disable cookies, note that some parts of the Site may not function properly.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Comet News has the discretion to update this privacy policy at any time. When we do, we will revise
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Your Acceptance of These Terms</h2>
        <p className="text-muted-foreground mb-4">
