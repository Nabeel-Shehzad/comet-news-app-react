...
const ArticlePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Article Image */}
      <div className="w-full h-64 sm:h-80 md:h-96 bg-gray-800 rounded-lg mb-6 flex items-center justify-center overflow-hidden">
        {article.urlToImage ? (
          <img 
      ...
      {/* Tags Section */}
      <div className="mb-8">
        <h3 className="text-sm text-gray-400 mb-2">Related Tags</h3>
