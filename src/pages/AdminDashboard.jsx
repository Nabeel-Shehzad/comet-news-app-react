          ...
          <form onSubmit={isEditingRoom ? handleUpdateRoom : handleCreateRoom} className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="w-full p-2 rounded-md bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center mt-6">
                ...
                />
                <label htmlFor="isHot" className="ml-2 text-sm text-gray-300">
      ...
      <div>
        ...
        {loading ? (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-400">Loading chat rooms...</p>
          </div>
        ) : chatRooms.length === 0 ? (
          <div className="text-center py-8 bg-gray-900 rounded-lg border border-gray-800">
            <MessageSquare size={40} className="mx-auto text-gray-600 mb-2" />
          ...
          <div className="space-y-4">
            {chatRooms.map(room => (
              <div 
                key={room.id} 
                className="flex flex-col sm:flex-row justify-between rounded-lg border border-gray-800 bg-gray-900"
              >
