...
const Layout = () => {
  ...
  return (
    <div className={`${theme} min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))]`}>
      ...
      <div className={`fixed left-0 top-0 z-50 h-screen w-72 transform bg-[hsl(var(--sidebar-background))] transition-transform duration-300 ease-in-out lg:translate-x-0 ${
